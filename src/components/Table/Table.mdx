  ...
  <tbody>
    {(() => {
      const tokens = {
        ...
        'table-header-font-size': '--size-font-size-xs',
        ...
        'table-header-border-width': '--size-border-width-sm',
