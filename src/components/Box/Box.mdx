...
<Canvas of={Stories.GapShorthand} />

<Canvas of={Stories.GapRowAndColumn} />
...
Set the maximum width of the Box by setting `maxWidth` to a [width token](?path=/docs/foundation-design-tokens--docs#width) or any valid css unit.

<Canvas of={Stories.WidthMax} />

## Min Width

Set the minimum width of the Box by setting `minWidth` to a [width token](?path=/docs/foundation-design-tokens--docs#width) or any valid css unit.

<Canvas of={Stories.WidthMin} />
...
[Width tokens](?path=/docs/foundation-design-tokens--docs#height) may be used to set height as well.
...
Set the maximum width of the Box by setting `maxHeight` to a [height token](?path=/docs/foundation-design-tokens--docs#height) or any valid css unit.

<Canvas of={Stories.HeightMax} />

## Min Height

Set the minimum width of the Box by setting `minHeight` to a [height token](?path=/docs/foundation-design-tokens--docs#height) or any valid css unit.

<Canvas of={Stories.HeightMin} />
