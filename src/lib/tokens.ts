...
export const BASE_COLOR_OPTIONS = (Object.keys(designTokens.color.base) as ColorName[])
  .map((colorName) => {
    if (colorName === 'white' || colorName === 'black' || colorName === 'magenta') return `${colorName}`;
...
export const BORDER_COLOR_OPTIONS = Object.keys(designTokens.color.border) as BorderColor[];
// export const BORDER_COLOR_VALUES = designTokens.color.border;

export const FONT_SIZE_OPTIONS = Object.keys((designTokens.size as any)['font-size']) as FontSize[];
...
export const HEADING_SIZE_OPTIONS = Object.keys(designTokens.size.heading) as HeadingSize[];

export const HEIGHT_OPTIONS = Object.keys((designTokens.size as any).dimension) as HeightSize[];
...
export const WIDTH_OPTIONS = Object.keys((designTokens.size as any).dimension) as WidthSize[];
