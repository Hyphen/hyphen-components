...
<table width="100%">
  ...
  <tbody>
    {Object.entries(designTokens.size.border.radius).map(([name, entry], i) => (
      <tr key={i}>
        <td>
...
<table width="100%">
  ...
  <tbody>
    {Object.entries(designTokens.size.border.width).map(([name, entry], i) => (
      <tr key={i}>
        <td>
...
<table width="100%">
  ...
  <tbody>
    {Object.entries(designTokens.size.font.weight).map(([name, entry], i) => (
      <tr key={i}>
        <td>
