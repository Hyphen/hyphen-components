...
import { color } from '@hyphen/hyphen-design-tokens/build/json/variables-color.json';
import { size } from '@hyphen/hyphen-design-tokens/build/js/variables-size';
import { asset } from '@hyphen/hyphen-design-tokens/build/js/variables-asset';
...
<ColorPalette>
  ...
  />
  <ColorItem
    title="color-brand-magenta"
    subtitle="magenta colors"
    colors={Object.keys(color.brand.magenta).reduce((acc, item, i) => {
      acc[item] = Object.keys(color.brand.magenta).map(
        (g) => color.brand.magenta[g].value
      )[i];
      return acc;
    }, {})}
  />
  ...
  <ColorItem
    ...
    colors={Object.keys(color.brand.blue).reduce((acc, item, i) => {
      acc[item] = Object.keys(color.brand.blue).map(
        (g) => color.brand.blue[g].value
      )[i];
      return acc;
    }, {})}
  />
  <ColorItem
    title="color-brand-purple"
    subtitle="purple colors"
    colors={Object.keys(color.brand.purple).reduce((acc, item, i) => {
      acc[item] = Object.keys(color.brand.purple).map(
        (g) => color.brand.purple[g].value
      )[i];
      return acc;
    }, {})}
  />
  <ColorItem
    title="color-brand-yellow"
    subtitle="yellow colors"
    colors={Object.keys(color.brand.yellow).reduce((acc, item, i) => {
      acc[item] = Object.keys(color.brand.yellow).map(
        (g) => color.brand.yellow[g].value
      )[i];
      return acc;
    }, {})}
  />
  <ColorItem
    title="color-brand-red"
    subtitle="red colors"
    colors={Object.keys(color.brand.red).reduce((acc, item, i) => {
      acc[item] = Object.keys(color.brand.red).map(
        (g) => color.brand.red[g].value
      )[i];
      return acc;
    }, {})}
  />
...
<table width="100%">
  ...
  <tbody>
    {Object.entries(size.spacing).map(([name, entry], i) => {
      console.log(entry.original.value);
      return (
        <tr key={i}>
          <td>
